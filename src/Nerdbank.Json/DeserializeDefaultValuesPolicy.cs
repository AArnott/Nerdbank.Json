...
{
	/// <summary>
	/// Deserialization will fail if any required properties have no specified values in the JSON payload,
	/// or when <see langword="null" /> values are encountered for non-nullable properties.
	/// </summary>
	Default = 0x0,

	/// <summary>
	/// Allows a <see langword="null" /> value to be deserialized into a non-nullable property.
	/// </summary>
	AllowNullValuesForNonNullableProperties = 0x1,

	/// <summary>
	/// Allows deserialization to succeed even if required properties are not specified in the JSON payload.
