...
public partial record JsonSerializer
{
	...
	/// <inheritdoc cref="SerializeObject(ref JsonWriter, object, ITypeShape, CancellationToken)"/>
	/// <returns>The serialized JSON text.</returns>
	public string SerializeObject(object? value, ITypeShape shape, CancellationToken cancellationToken = default)
	{
		Requires.NotNull(shape);
...
#pragma warning restore CS1573 // Parameter has no matching param tag in the XML comment (but other parameters do)
	...
	public object? DeserializeObject(string json, ITypeShape shape, CancellationToken cancellationToken = default)
	{
		Requires.NotNull(json);
		Requires.NotNull(shape);
...
#pragma warning restore CS1573 // Parameter has no matching param tag in the XML comment (but other parameters do)
	...
	/// <inheritdoc cref="DeserializeObject(ref JsonReader, ITypeShape, CancellationToken)"/>
	/// <param name="buffer">The JSON to deserialize from.</param>
#pragma warning disable CS1573 // Parameter has no matching param tag in the XML comment (but other parameters do)
