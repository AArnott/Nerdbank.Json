...
/// <summary>
/// Represents errors that occur during JSON serialization.
/// </summary>
public class JsonSerializationException : Exception
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="JsonSerializationException"/> class with a specified error message.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="JsonSerializationException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
	/// </summary>
	/// <param name="message">The message that describes the error.</param>
	...
	{
		if (innerException is JsonSerializationException inner)
		{
	...
	/// <summary>
	/// Throws an exception explaining that null was unexpectedly encountered while deserializing a value type.
	/// </summary>
	/// <typeparam name="T">The value type that was being deserialized.</typeparam>
	/// <returns>Nothing. This method always throws.</returns>
	[DoesNotReturn]
	internal static JsonSerializationException ThrowUnexpectedNullWhileDeserializing<T>() => throw new JsonSerializationException("Unexpected null encountered while deserializing " + typeof(T).FullName) { Code = ErrorCode.UnexpectedNull };
}
